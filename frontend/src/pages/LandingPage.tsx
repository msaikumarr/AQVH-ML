  ...
  const features = [
    {
      ...
      description: "Advanced VQC model for market prediction with 63.33% accuracy"
    },
    {
      icon: TrendingUp,
      ...
      <main className="relative z-10 container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            using Variational Quantum Classifiers with 63.33% accuracy.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <Card className="p-6 bg-card/50 border-border/50">
              <div className="text-3xl font-bold gradient-quantum bg-clip-text text-transparent">63.33%</div>
            ...
            <Card className="p-6 bg-card/50 border-border/50">
              <div className="text-3xl font-bold text-accent">70.00%</div>
              <div className="text-sm text-muted-foreground">IBM Quantum Accuracy</div>
            </Card>
          </div>
        </div>
